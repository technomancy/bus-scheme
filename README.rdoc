...
the file R5RS.diff for an incomplete list of ways in which Bus Scheme
differs from the standard, both things that are yet unimplemented and
...
TODO: Web and RESTful application development are part of the
...
and Interpretation of Computer Programs videos, reading lots about
Common Lisp, and writing lots of Emacs Lisp. If there are huge gaping
flaws in the implementation, this is likely to be why.
